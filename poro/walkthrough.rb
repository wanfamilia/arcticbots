...
- uth nightfall: uth fort, darren steal orders or kill but he yells, orders let you into castle, run goodie summoner north and west, summon, cain is west and up but there may be aggroes
'
  align = %{
Alignment Change
...
'
  ...
  INLINE_DATA = {
    ...
    'kharolis' => kharolis, 'alignment change' => align, 'dark knight dk quest' => dk_quest,
